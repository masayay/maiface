...
# Embedding Files
EMBEDDINGS = 'C:/maiface/embeddings'

# Pretrained model cache directory
CACHE_DIR = 'C:/maiface/cache'
...
# When use 'text'
FAISS_QUEUE = 'C:/maiface/faiss_queue.txt'
#FAISS_QUEUE = ''
...
PICTURES = 'C:/maiface/picture'

# Embedding file output directory
EMBEDDINGS_BATCH_OUT = 'C:/maiface/batchout'
...
BATCH_LOGFILE = 'C:/maiface/log/batch_log.txt'